...
const newLocal = `<div class="button" id="retry">`;
...
function loadAuthorizeView() {
	...
	function wait() {
		// Show user controls
		var controls = `${newLocal + localization["Authorize"]["Retry"]}</div><div class="button-transparent" id="exit">${localization["Authorize"]["Exit"]}</div>`;
